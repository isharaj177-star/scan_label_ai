...
def run_backend():
    ...
    # Use unbuffered Python and add log level
    # Note: --reload causes reload errors on Windows, but it's useful for development
    # Remove --reload if you want cleaner logs
    import subprocess
    backend_process = subprocess.Popen(
        [sys.executable, "-u", "-m", "uvicorn", "main:app", "--host", "0.0.0.0", "--port", "8001", "--log-level", "info", "--reload"],
